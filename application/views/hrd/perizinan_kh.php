    ...
    <div class="content">
        <div class="module">
            ...
            <div class="dropdown pull-right">
                ...
                <h3>Data Izin Khusus Karyawan PT PYXIS Ultimate Solution</h3>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display"
                    ...
                    <?php $no = 1; foreach ($perizinan_kh as $prz) {?>
                        <tr class="odd gradeX">
                            ...
                            <?php } ?>
                           <?php if ($prz->status == 0) { ?>
                                <td><a class='btn btn-success btn-xs' onclick="return confirm('Konfirmasi Izin')" href="<?php echo base_url('index.php/Hrd/aprove2/'. $prz->kd_izin) ?>"><span class="menu-icon icon-ok"></span></a></td>
                            <?php } else { ?>
