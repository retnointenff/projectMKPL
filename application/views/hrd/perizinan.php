    ...
    <div class="content">
        <div class="module">
            ...
            <div class="dropdown pull-right">
                ...
                <h3>Data Izin Cuti Karyawan PT PYXIS Ultimate Solution</h3>
            ...
            <div class="module-body table">
                <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display"
                    ...
                    <script>
                        function confirmasi() {
                            var r = confirm("Apa Anda yakin menyetujui izin ini?");
                            if(r == true) {
                                href="<?php echo base_url('index.php/Hrd/aprove/'. $prz->kd_cuti) ?>";
                            } else {

                            }
                        }
                    </script>
                    <?php $no = 1; foreach ($perizinan as $prz) {?>
                        <tr class="odd gradeX">
                            <td><?php echo $no++?></td>
                            <td><?php echo $prz->nama?></td>
                            <td><?php echo $prz->jabatan?></td>
                            <td><?php echo $prz->dari?></td>
                            <td><?php echo $prz->masuk?></td>
                            ...
                            <?php } ?>
                            <?php if ($prz->status == '0') { ?>
                                <td><a class='btn btn-success btn-xs' onclick="return confirm('Konfirmasi Izin')" href="<?php echo base_url('index.php/Hrd/aprove/'. $prz->kd_cuti) ?>"><span class="menu-icon icon-ok"></span></a></td>
                            <?php } else { ?>
